...
class Contact extends React.Component {
    constructor(props) {
      ...
      handleClickOnInput1=(event) => 
      {
        ...
        const errorStyle = `3px solid #ff3860`;
        const VerifiedStyle = `2px solid #00d1b2`
    ...
    //
      ...
      console.log(this.state.HasErrorEmail,this.state.HasErrorUsername,this.state.HasErrorMessage)
      if(this.state.HasErrorEmail == VerifiedStyle && this.state.HasErrorUsername == VerifiedStyle && this.state.HasErrorMessage == VerifiedStyle )
      {
          ...
          axios({
            ...
            method: 'post',
            url: ' http://92.243.10.85/Owedding_BACK/O_wedding-back-end/public/api/contact/admin',
            headers:{
            ...
            //TENTATIVE DE PROCEDURE MERCURE


            // const url = new URL('https://localhost:3000/hub');
            // url.searchParams.append('topic', 'https://localhost:3001/login');
        ...
        if(this.state.HasErrorEmail == VerifiedStyle && this.state.HasErrorUsername == VerifiedStyle && this.state.HasErrorMessage == VerifiedStyle )
        {
          ...
          if(this.state.formName ==='Contact')
          {
            ...
            axios({
              ...
              method: 'post',
              url: ' http://92.243.10.85/admin/api/contact/admin',
              headers:{
                'JWT' : 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJtZXJjdXJlIjp7InB1Ymxpc2giOlsiKiJdfX0.NFCEbEEiI7zUxDU2Hj0YB71fQVT8YiQBGQWEyxWG0po',
                'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
